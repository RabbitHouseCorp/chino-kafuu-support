...
module.exports = {
  ...
  run: (client: ChinoClient, guild: Guild, member: Member) => {
    ...
    embed.addField('<a:chino_petpet:760564885280784405> Invite your friends', `You can invite some of your friends copying [this invite](${guild.vanityURL !== null ?`https://discord.gg/${guild.vanityURL}` : guild.getInvites().then((invites) => `https://discord.gg/${invites[0].code}`)})`, true)
